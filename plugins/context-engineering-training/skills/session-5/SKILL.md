...
name: session-5
description: >
  Session 5: Cowork Mode. Teaches what Cowork adds, approval modes, artifacts,
  sub-agents, research in Cowork, and error recovery. Three exercises including
  moving the workflow into Cowork and producing a real deliverable. Use when:
  STATE.md shows Session 5, or user says "session 5" or "cowork".
user-invocable: true
---
...
Point to the training portal: "After this session completes, your progress portal will update. That portal is an artifact — a standalone HTML file generated by a skill, living in your workspace. It's not conversation text; it's a deliverable."

### Debrief

"Artifacts are output containers. When your workflow produces something that needs to be a file — not just a chat response — artifacts or direct file creation are how Cowork delivers it."

### Quick Check

"When should [your workflow] produce an artifact versus just giving you a chat response? What's the deciding factor?"

🛑 **CHECKPOINT** — Good answer identifies that artifacts are for deliverables that need to live outside the conversation — files you'd open, share, edit, or use downstream. Chat responses are for discussion and iteration. If they're unsure, ask: "Would you copy-paste this into a file anyway? Then it should be an artifact."

---

## Concept 4: Sub-Agents
...
## Concept 6: Error Recovery & Debugging
...
3. Sub-agents are a context management technique — work without context consumption.
4. Research in Cowork: search, save, review, produce. Explicit step, not assumption.
5. Three failure modes: context exhaustion, tool failures, scope drift. Recognize which.
6. When something feels off, stop and diagnose. Don't push through.
